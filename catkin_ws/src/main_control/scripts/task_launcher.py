...
class TaskLauncher:
    ...
    def __init__(self):
        ...
        self.task_map = {
            1: ["main_control", "A_B_C_D_1.launch"],
            2: ["main_control", "B_C_D_1.launch"],
            3: ["main_control", "BtoC_D_1.launch"],
            4: ["main_control", "C_D_1.launch"],
            5: ["main_control", "CtoD_1.launch"],
            6: ["main_control", "D_1.launch"]
        }
