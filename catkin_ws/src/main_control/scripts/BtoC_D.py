...
##########################################################################   
    ...
    def take_basket(self):
        ...
        while not rospy.is_shutdown():
            ...
            if current_state == "back to get basket":
    ...
    def A_B_C_D_flow(self):
        ...
        while not rospy.is_shutdown():
            ...
            if current_state == "COFFEE_FLOW_DONE":
                self.navigate_by_wall(rear = 1.24, left=0.4, angle = 0.0, align_wall="left")
                self.navigate_by_wall(rear = 1.24, left=3, angle = 0.0, align_wall="left")
